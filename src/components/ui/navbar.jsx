...
export const NavFeatured = ({
  ...
  <div className="flex flex-col gap-4 min-w-55 max-w-65">
    <div className="w-full aspect-square max-w-45 rounded-2xl overflow-hidden bg-blue-60 shrink-0">
      {image ?? (
        <div className="w-full h-full bg-linear-to-br from-blue-60 to-[#1A6FFF]" />
      )}
    </div>
