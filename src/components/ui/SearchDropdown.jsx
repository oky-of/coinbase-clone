...
const SearchDropdown = ({ query }) => {
  ...
  return (
    <MotionDiv
      ...
      <div className="w-full max-w-307 mx-auto px-8 lg:px-12 pointer-events-none">
        <div className="ml-auto w-full max-w-170 bg-white rounded-2xl shadow-[0_8px_32px_rgba(0,0,0,0.12)] overflow-hidden pointer-events-auto">
          {/* Tabs */}
