...
/**
 * FilterDropdown — compact pill dropdown with optional icon, search, and selection.
 *
 * Props:
...
const FilterDropdown = ({
	...
	return (
		<div ref={ref} className="relative">
			...
			{/* Dropdown panel */}
			{isOpen && (
				<div className="absolute top-full left-0 mt-2 z-50 bg-white rounded-xl border border-gray-10 shadow-elevation-2 min-w-45 max-h-80 overflow-hidden flex flex-col animate-in fade-in">
					{/* Search input */}
					{searchable && (
