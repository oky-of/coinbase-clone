...
/* ── Animated price ──
   We animate all glyphs together whenever the formatted value changes.
── */
...
const AssetRow = ({ asset }) => {
  ...
  return (
    <div className="flex flex-col w-full h-20 py-4 transition-colors duration-150 hover:bg-white/4 rounded-lg cursor-pointer">
      <div className="flex items-center justify-between w-full gap-2">
        ...
        <div className="flex flex-col items-end px-2 py-0.5">
          ...
          {change == null ? (
            <span className="text-md leading-[1em] font-normal text-gray-40 mt-1">
              --
            </span>
          ) : (
