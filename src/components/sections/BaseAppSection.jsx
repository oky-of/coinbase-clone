			...
			<Container>
				<div className="flex flex-col md:flex-row-reverse items-center gap-10 md:gap-16">
					...
					<div className="w-full md:w-1/2">
						...
						<Button variant="tertiary" size="xl" className='text-xl p-4 px-8'>
							Learn more
						</Button>
					</div>
					...
					<div className="w-full md:w-1/2 flex justify-center">
						<div
							className="relative w-full overflow-hidden flex items-center rounded-[3rem]  justify-center"
						...
						>
							<picture>
								...
								<img
									...
									width="1200"
									height="960"
									className="w-full h-108 object-contain"
								/>
							</picture>
						</div>
					</div>
