				...
				<div className="w-full flex-1 p-8 text-center flex flex-col justify-center">
					{subscribed ? (
						<div className="flex flex-col items-center justify-center space-y-4 transition-opacity duration-500">
							...
							<p className="text-gray-60 mt-2">Thanks for subscribing to our market updates.</p>
							<button
								onClick={onClose}
						...
						<div className="flex flex-col items-center transition-opacity duration-500">
							<h3 className="mb-2 text-3xl font-display font-medium text-black">
								Keep learning with Crypto Nexus
							</h3>
							...
							<p className="mt-6 text-xs text-gray-50 leading-relaxed">
								By submitting your email address, you are signing up to receive crypto market updates in your inbox. For information on how demo data is handled, see our <a href="#" className="text-blue-60 hover:underline">privacy notice</a>.
							</p>
						</div>
					)}
				</div>
