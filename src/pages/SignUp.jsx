...
function AddressFailStep({ onRetry }) {
  return (
    <div className="min-h-screen bg-[#0A0B0D] flex flex-col items-center justify-center px-4">
      <div className="flex flex-col items-center">
        <img
          src="https://static-assets.coinbase.com/ui-infra/illustration/v1/spotSquare/svg/dark/verifyInfo-3.svg"
          alt="Document missing address"
          className="w-32 h-32 mb-8"
        />
        <h1 className="text-2xl font-bold text-white mb-2 text-center">
          Document missing address
        </h1>
        <p className="text-[#8A919E] text-center mb-6 max-w-md">
          We are unable to verify your address because your document is missing
          your address. Try again and make sure you choose a document that
        ...
        <button
          className="w-64 h-14 rounded-full bg-[#0052FF] hover:bg-[#1a5cff] text-white font-bold text-lg"
          onClick={onRetry}>
          Try Again
        </button>
      </div>
  ...
  return (
    <div className="min-h-screen bg-[#0A0B0D] flex flex-col items-center justify-center px-4">
      <div className="w-full max-w-lg mx-auto">
        ...
        <p className="text-[#8A919E] mb-8">
          Regulations require us to collect a document to verify the address you
          ...
          <div className="flex items-start gap-4">
            <div className="flex items-center justify-center w-10 h-10 bg-[#23262B] rounded-lg">
              <svg width="24" height="24" viewBox="0 0 24 24">
                ...
                <rect x="16" y="7" width="4" height="4" rx="1" fill="#fff" />
                <path
                  d="M18 9.5l1 1 2-2"
                  stroke="#00A87A"
                  strokeWidth="1.5"
            ...
            <div>
              ...
              <div className="text-[#8A919E] text-sm">
                Upload a copy of your bank statement, utility bill or credit
                card statement in your name alone.
                <br />
                <a href="#" className="text-[#0052FF] underline">
                  See other valid forms of documents.
                </a>
              </div>
            </div>
          </div>
          <div className="flex items-start gap-4">
            <div className="flex items-center justify-center w-10 h-10 bg-[#23262B] rounded-lg">
              <svg width="24" height="24" viewBox="0 0 24 24">
                ...
                <polygon points="12,18 10,16 14,16" fill="#0052FF" />
              </svg>
            </div>
            <div>
              <div className="font-semibold text-white">
                Upload a document in English
              </div>
              <div className="text-[#8A919E] text-sm">
                We can only accept documents that are in English. Documents in
        ...
        <div className="flex flex-col items-center bg-[#16181C] rounded-xl border border-[#23262B] py-10 px-6 mb-8">
          <img
            src="https://static-assets.coinbase.com/ui-infra/illustration/v1/spotSquare/svg/dark/commerceInvoices-3.svg"
            alt="Upload"
          ...
          <button
            ...
            <svg width="24" height="24" viewBox="0 0 24 24">
              <circle cx="12" cy="12" r="12" fill="#00A87A" />
              <path
                d="M12 8v8M8 12h8"
                stroke="#fff"
                strokeWidth="2"
          ...
          <div className="text-white font-medium mb-2">
            Upload or drag and drop a copy of your chosen document.
          </div>
          <div className="text-[#8A919E] mb-6">
            Accepted formats: PNG, JPEG, or PDF.
          </div>
          <button
            className="w-48 h-12 rounded-full bg-[#0052FF] hover:bg-[#1a5cff] text-white font-semibold text-lg"
            onClick={() =>
        ...
        <div className="bg-[#00113A] rounded-lg p-4 flex items-center gap-3">
          ...
          <div className="text-[#C7D1E0] text-sm">
            Your document will only be used to verify your address. No other
            information on the document will be associated with your account.
          </div>
        </div>
      </div>
    </div>
      ...
      <div className="w-full max-w-lg mx-auto">
        ...
        <div className="flex flex-col items-center mb-8">
          {file && file.type.startsWith("image") ? (
            <img
              ...
              className="max-w-full max-h-[400px] rounded-xl border border-[#23262B] mb-6"
            />
          ) : (
            <div className="w-full h-48 flex items-center justify-center bg-[#16181C] rounded-xl border border-[#23262B] mb-6 text-[#8A919E]">
        ...
        <div className="mb-8">
          <div className="font-bold text-white mb-2">
            Make sure your document is clear and not cut off.
          </div>
        ...
        <div className="flex flex-col gap-4">
          <button
            className="w-full h-14 rounded-full bg-[#0052FF] hover:bg-[#1a5cff] text-white font-bold text-lg"
            onClick={onConfirm}>
            Yes, looks good
          </button>
          <button
            className="w-full h-14 rounded-full bg-[#23262B] text-white font-bold text-lg"
            onClick={onReupload}>
            Re-upload
          </button>
        </div>
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh]">
      <div className="mb-8">
        ...
        <svg
          ...
          <g>
            ...
            <path
              d="M99.5 119.5L114.25 134.5L145.25 104.5"
              stroke="white"
              strokeWidth="6"
              strokeLinecap="round"
              strokeLinejoin="round"
      ...
      <p className="text-gray-400 mb-8 text-center">
        Your ID has been verified, you can continue.
      </p>
      <button
...
/* ════════════════════════════════════════════════════
   ...
   ════════════════════════════════════════════════════ */
const StepEmail = ({ name, setName, email, setEmail, password, setPassword, onSubmit, error, isLoading }) => (
  <Shell>
    <form
      onSubmit={(e) => {
        e.preventDefault();
        if (email.trim() && name.trim() && password.trim()) onSubmit();
      }}>
...
const StepVerifyEmail = ({ email, onNext }) => {
  ...
  const handleKey = (i, e) => {
    if (e.key === "Backspace" && !code[i] && i > 0) focusAt(i - 1);
  };
  ...
  return (
    <Shell>
      ...
      <p className="text-[0.9375rem] text-[#8A919E] mb-6 leading-6">
        Check your email{" "}
        <span className="font-semibold text-white">{email}</span>. This helps us
  ...
  <Shell>
    <div className="flex flex-col items-center text-center">
      ...
      <p className="text-[0.9375rem] text-[#8A919E] mb-8 leading-6 max-w-sm">
        You can learn more and unsubscribe anytime via your account settings or
        our Support Portal.
      </p>
...
const StepCountry = ({
  ...
  <Shell>
    <form
      ...
      <DarkSelect
        label="Citizenship"
        hint="As shown on your ID document"
        value={citizenship}
      ...
      <DarkSelect
        ...
        hint="You will need to provide your ID and Proof of Address from this country"
        value={residence}
    ...
    <Shell>
        ...
        {ids.map((id) => (
          <button
            ...
            <div className="flex-1 min-w-0">
              ...
              {id.sub && (
                <p className="text-[0.8125rem] text-[#5B616E]">{id.sub}</p>
              )}
            </div>
            <ChevronRight />
          </button>
      ...
      <div className="rounded-xl border border-[#2C2F36] bg-[#1E2025] p-4 mb-6">
        <p className="text-[0.8125rem] text-[#5B616E] leading-5">
          By selecting your ID type on this screen, you agree that our (and our
          service providers) collection, use, and storage of your biometric
          information for identity verification. Learn more in Section 5 of our{" "}
  ...
  return (
    <Shell>
      ...
      <div className="flex gap-4 mb-6">
        ...
        <button
          ...
          <span className="text-[0.8125rem] text-[#5B616E]">
            {front || "Drag & drop or click to upload"}
          </span>
        </button>
        <input
          ref={frontRef}
        ...
        <button
          ...
          />
          <span className="text-[0.8125rem] text-[#5B616E]">
            {back || "Drag & drop or click to upload"}
          </span>
        </button>
        <input
          ref={backRef}
      ...
      <p className="text-[0.8125rem] text-[#8A919E] text-center leading-5 mb-6">
        Please do not redact, watermark or otherwise obscure any part of your
        ID. This will help ensure we can verify your identity document as
...
const SignUp = () => {
  ...
  switch (step) {
    case 0:
      return <StepEmail name={name} setName={setName} email={email} setEmail={setEmail} password={password} setPassword={setPassword} onSubmit={handleRegister} error={error} isLoading={isLoading} />;
    case 1:
      return <StepVerifyEmail email={email} onNext={next} />;
    case 2:
      return <StepAccountSetup onNext={next} />;
    case 3:
      return <StepEmailOptIn onNext={next} />;
    case 4:
      return (
        <StepCountry
    ...
    case 5:
      return (
        <StepBirth
          ...
          setCountry={setBirthCountry}
          onNext={next}
        />
      );
    case 6:
      return <StepIdType onSelect={() => next()} />;
    case 7:
      return <StepUpload onNext={next} onBack={back} />;
    case 8:
      return <StepVerifying />;
    case 9:
      return <AllSetStep onContinue={next} />;
    case 10:
      return (
        <VerifyAddressStep
          onNext={next}
    ...
    case 11:
      return (
        <PreviewAddressStep
          file={addressFile}
          onConfirm={() => setStep(12)}
          onReupload={() => setStep(10)}
        />
      );
    case 12:
      return <VerifyingAddressStep />;
    case 13:
      return <AddressFailStep onRetry={() => setStep(10)} />;
    default:
      return <StepVerifying />;
  }
};
