            ...
            <form onSubmit={handleEmailContinue}>
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  className="w-full h-14 px-4 rounded-xl bg-gray-90 border border-[#2C2F36] text-white placeholder:text-gray-60 text-[0.9375rem] outline-none focus:border-blue-60 transition-colors"
                />
              </div>
              ...
              <div className="flex items-center gap-3 mb-5">
                ...
                <span className="text-[0.75rem] font-semibold text-gray-60 tracking-wider">
                  OR
                </span>
                <div className="flex-1 h-px bg-[#2C2F36]" />
              </div>
              ...
              <div className="flex flex-col gap-3 mb-6">
                <button
                  type="button"
                  className="w-full h-14 rounded-full bg-gray-90 hover:bg-[#2C2F36] border border-[#2C2F36] text-white font-semibold text-[0.9375rem] flex items-center justify-center gap-3 transition-colors">
                  <PasskeyIcon />
              ...
              {/* Footer links */}
              <p className="text-center text-[0.875rem] text-gray-60 mb-4">
                Don&apos;t have an account?{" "}
                <Link
                  to="/signup"
                  className="text-blue-60 hover:underline font-medium">
                  Sign up
                </Link>
              </p>

              <p className="text-center text-[0.75rem] text-gray-60 leading-5">
          ...
          {step === "password" && (
            <form onSubmit={handlePasswordContinue}>
              ...
              <div className="flex items-center gap-3 w-full h-16 px-4 rounded-xl border border-[#2C2F36] bg-gray-90 mb-6">
                <UserAvatar />
                <span className="text-[0.9375rem] text-white truncate">
                  {email}
                </span>
              </div>
              ...
              <div className="mb-2">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full h-14 px-4 pr-12 rounded-xl bg-gray-90 border border-[#2C2F36] text-white placeholder:text-gray-60 text-[0.9375rem] outline-none focus:border-blue-60 transition-colors"
                  />
                  <button
                    type="button"
                    onClick={() => setShowPassword((v) => !v)}
                    className="absolute right-4 top-1/2 -translate-y-1/2 text-gray-60 hover:text-white transition-colors">
