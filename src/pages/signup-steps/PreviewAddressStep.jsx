  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col items-center justify-center px-4">
      <div className="w-full max-w-lg mx-auto">
        ...
        <p className="text-[#8A919E] mb-6">Make sure that the address listed on your document and the address you entered in this demo match exactly.</p>
        <div className="flex flex-col items-center mb-8">
          {file && file.type.startsWith('image') ? (
            <img src={URL.createObjectURL(file)} alt="Uploaded document" className="max-w-full max-h-100 rounded-xl border border-[#23262B] mb-6" />
          ) : (
        ...
        <div className="flex flex-col gap-4">
          <button className="w-full h-14 rounded-full bg-blue-60 hover:bg-[#1a5cff] text-white font-bold text-lg" onClick={onConfirm}>Yes, looks good</button>
