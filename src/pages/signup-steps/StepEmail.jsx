  ...
  <Shell>
    <form onSubmit={(e) => { e.preventDefault(); if (email.trim()) onNext(); }}>
      ...
      <div className="flex items-center gap-3 my-5">
        ...
        <span className="text-[0.75rem] font-semibold text-gray-60 tracking-wider">OR</span>
        <div className="flex-1 h-px bg-[#2C2F36]" />
      </div>

      <div className="flex flex-col gap-3 mb-6">
        <button type="button" className="w-full h-14 rounded-full bg-gray-90 hover:bg-[#2C2F36] border border-[#2C2F36] text-white font-semibold text-[0.9375rem] flex items-center justify-center gap-3 transition-colors">
